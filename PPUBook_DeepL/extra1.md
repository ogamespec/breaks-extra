...
This section contains excerpts from the sources of the PPU implementation on the Verilog.

If you read the whole book and immediately rushed to make PPU on the Verilog, stop it. It's already done :smile:

The sources are published as is, all comments can be sent via GitHub (where they will soon be published in full as well), or via Discord.
