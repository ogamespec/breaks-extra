...
Как пример программирования APU приводятся выдержки из исходного кода игры Bomberman.

Весь исходный код игры находится тут: https://github.com/emu-russia/bomberman-nes
